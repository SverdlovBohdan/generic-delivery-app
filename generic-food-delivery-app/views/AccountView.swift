...
struct AccountView: View {
    ...
    private let disclaimer: String = String("💡") + String(localized: "All data is stored on the device. Used only for auto-filling.")
    private let accountTitle: String  = String("🥸") + String(localized: "Account")
    private let paymentMethodTitle: String = String("💳 ") + String(localized: "Payment method")
    private let addressesTitle: String = String("🏡 ") + String(localized: "Addresses")
    ...
    private var paymentMethodBindign: Binding<Customer.PaymentMethod> {
        return .init {
            return viewState.paymentMethod
        } set: { newMethod in
